...
const MyEnrollments = () => {
  ...
  const {enrolledCourses, calculateCourseDuration , navigate, userData,fetchUserEnrolledCourses,getToken , backendUrl, calculateNoOfLectures} = useContext(AppContext);
